...
@Component({
  selector: 'app-compagnie-assurance-edit-admin',
  templateUrl: './compagnie-assurance-edit-admin.component.html'
})
export class CompagnieAssuranceEditAdminComponent extends AbstractEditController<CompagnieAssuranceDto, CompagnieAssuranceCriteria, CompagnieAssuranceService>   implements OnInit {
