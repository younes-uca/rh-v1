...
@Component({
  selector: 'app-type-demande-conge-create-admin',
  templateUrl: './type-demande-conge-create-admin.component.html'
})
export class TypeDemandeCongeCreateAdminComponent extends AbstractCreateController<TypeDemandeCongeDto, TypeDemandeCongeCriteria, TypeDemandeCongeService>  implements OnInit {
