...
@Component({
  selector: 'app-etat-demande-conge-edit-admin',
  templateUrl: './etat-demande-conge-edit-admin.component.html'
})
export class EtatDemandeCongeEditAdminComponent extends AbstractEditController<EtatDemandeCongeDto, EtatDemandeCongeCriteria, EtatDemandeCongeService>   implements OnInit {
