...
@Component({
  selector: 'app-education-edit-admin',
  templateUrl: './education-edit-admin.component.html'
})
export class EducationEditAdminComponent extends AbstractEditController<EducationDto, EducationCriteria, EducationService>   implements OnInit {
