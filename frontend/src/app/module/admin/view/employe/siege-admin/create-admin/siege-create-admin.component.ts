...
@Component({
  selector: 'app-siege-create-admin',
  templateUrl: './siege-create-admin.component.html'
})
export class SiegeCreateAdminComponent extends AbstractCreateController<SiegeDto, SiegeCriteria, SiegeService>  implements OnInit {
